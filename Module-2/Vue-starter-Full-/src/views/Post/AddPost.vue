        ...
        <div class="flex flex-col gap-10">
          ...
          <div>
            ...
            >
              ...
              <option :value="item.title" v-for="item in getCategorys">
                {{ item.title }}
              </option>
            </select>
          </div>
...
export default {
  ...
  computed: {
    getCategorys() {
      console.log(this.$store.state.categoryActions.categoryList);
      return this.$store.state.categoryActions.categoryList;
    },
  },
  ...
  methods: {
    ...
    addNewPost(e) {
      ...
      fd.append("full_text", this.full_text);
      fd.append("base_image", this.base_image, "base_image");
      ...
      if (
        ...
        toast.warning("Please enter a full_text and a base_image or a title");
      } else {
